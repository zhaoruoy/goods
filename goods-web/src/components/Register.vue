            ...
            <div class="login-content">
                ...
                <el-form :model="loginForm" label-width="100px" :rules="rules" ref="loginForm">
                    <el-form-item label="账号" prop="no">
                        <el-input style="width: 200px" type="text" v-model="loginForm.no" autocomplete="off"
                            size="small"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="重复密码" prop="password">
                        <el-input style="width: 200px" type="password" v-model="loginForm.rpassword" show-password
                            autocomplete="off" size="small" @keyup.enter.native="confirm"></el-input>
                    </el-form-item>

                    <el-form-item>
                        <el-button type="primary" @click="confirm" :disabled="confirm_disabled">注册</el-button>
                        <el-button type="success" @click="login" :disabled="confirm_disabled">登录</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </div>
        ...
        return {
            ...
            rules: {
                ...
                password: [
                    ...
                    { min: 3, max: 16, message: '3-16个字符', trigger: 'blur' },
                ],
                rpassword: [
